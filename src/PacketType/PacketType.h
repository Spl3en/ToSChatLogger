...
typedef enum PacketType {
	...
	CB_LOGOUT = 5, // Size = 10
	CB_START_GAME = 10, // Size = 13
	CB_START_BARRACK = 6, // Size = 11
	CB_COMMANDER_CREATE = 7, // Size = 92
	CB_COMMANDER_DESTROY = 8, // Size = 11
	CB_CHECK_CLIENT_INTEGRITY = 9, // Size = 74
	CB_ECHO = 13, // Size = 30
	CB_BARRACKNAME_CHANGE = 11, // Size = 74
	CB_COMMANDER_MOVE = 12, // Size = 31
	BC_LOGINOK = 14, // Size = 121
	BC_LOGIN_PACKET_RECEIVED = 15, // Size = 6
	BC_LOGOUTOK = 16, // Size = 6
	BC_START_GAMEOK = 20, // Size = 33
	BC_SINGLE_INFO = 21, // Size = 317
	BC_COMMANDER_LIST = 17, // Size = 0
	BC_COMMANDER_CREATE = 18, // Size = 326
	BC_COMMANDER_DESTROY = 19, // Size = 7
	BC_MESSAGE = 22, // Size = 0
	BC_ECHO = 23, // Size = 26
	...
	BC_MYPAGE_MAP = 24, // Size = 0
	BC_BARRACKNAME_CHANGE = 25, // Size = 75
	CB_VISIT = 75, // Size = 74
	CB_BUY_THEMA = 76, // Size = 22
	...
	CS_ADD_RELATION_SCORE = 2930, // Size = 88
	CS_GET_LIKE_COUNT = 2931, // Size = 16
	CS_LIKE_IT = 2927, // Size = 80
	CS_UNLIKE_IT = 2928, // Size = 16
	CS_LIKE_IT_CONFIRM = 2929, // Size = 16
	CS_REQ_RELATED_PC_SESSION = 2919, // Size = 16
	CS_REDIS_SKILLPOINT = 2920, // Size = 22
	CS_PARTY_CLIENT_INFO_SEND = 2921, // Size = 0
	CS_NORMAL_GAME_START = 2922, // Size = 6
	CS_PVP_COMMAND = 2923, // Size = 18
	CS_REQUEST_PVP_RANKING = 2924, // Size = 83
	CS_INVITE_PARTY_PVP = 2925, // Size = 10
	CS_ACCEPT_PARTY_PVP = 2926, // Size = 19
	...
	ZC_ENTER_PC = 3006, // Size = 408
	ZC_ENTER_MONSTER = 3007, // Size = 0
	ZC_ENTER_DUMMYPC = 3008, // Size = 300
	ZC_UPDATED_DUMMYPC = 3009, // Size = 258
	...
	ZC_UPDATED_PCAPPEARANCE = 3027, // Size = 258
	...
	CZ_FOOD_TABLE_TITLE = 3247, // Size = 79
	...
	ZC_RECOMMEND_PARTYMEMBER_INFO = 3500, // Size = 0
	...
	ZC_NEAR_PARTY_LIST = 3475, // Size = 0
	ZC_RECOMMEND_PARTY_INFO = 3476, // Size = 0
	CZ_REQUEST_SOME_PARTY = 3477, // Size = 90
	CZ_REFRESH_MEMBERRECOMMEND_LIST = 3478, // Size = 10
	ZC_TO_SOMEWHERE_CLIENT = 3479, // Size = 0
	CZ_REVEAL_NPC_STATE = 3480, // Size = 14
	CZ_CHANGE_CHANNEL = 3481, // Size = 12
	CZ_REQ_CHANNEL_TRAFFICS = 3482, // Size = 12
	CZ_BUY_PROPERTYSHOP_ITEM = 3483, // Size = 0
	CZ_SKILL_USE_HEIGHT = 3484, // Size = 14
	CZ_ACCEPT_PARTY_QUEST = 3485, // Size = 20
	CZ_ACCEPT_PARTY_EVENT = 3486, // Size = 20
	CZ_DELETE_PARTY_EVENT = 3487, // Size = 20
	CZ_PING = 3488, // Size = 10
	ZC_PING = 3489, // Size = 10
	ZC_XIGNCODE_BUFFER = 3490, // Size = 524
	CZ_XIGNCODE_BUFFER = 3491, // Size = 524
	CZ_SYSTEM_LOG_SAVE_TO_MONGODB = 3492, // Size = 280
	CZ_CHANGE_TITLE = 3493, // Size = 74
	CZ_PC_COMMENT_CHANGE = 3494, // Size = 0
	CZ_AUTTOSELLER_BUYER_CLOSE = 3495, // Size = 18
	CZ_REQ_ITEM_LIST = 3496, // Size = 11
	CZ_HIT_MISSILE = 3497, // Size = 14
	CZ_I_NEED_PARTY = 3498, // Size = 23
	CZ_PARTY_JOIN_BY_LINK = 3499, // Size = 19
	CZ_PVP_ZONE_CMD = 3501, // Size = 22
	CZ_PVP_CHAT = 3502, // Size = 0
	CZ_CARDBATTLE_CMD = 3503, // Size = 26
	CZ_REQ_UPDATE_CONTENTS_SESSION = 3504, // Size = 10
	CZ_REQ_FRIENDLY_FIGHT = 3505, // Size = 15
	CZ_CART_POSITION = 3506, // Size = 26
	CZ_REQ_RIDE_CART = 3507, // Size = 18
	CZ_DUMMYPC_SKILL_POS = 3508, // Size = 26
