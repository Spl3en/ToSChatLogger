...
void packetTypeInit() {
	...
	for (int i = 0; i < PACKET_TYPES_MAX_INDEX; i++) {
		strcpy(packets[i].string, "UNKNOWN_PACKET_TYPE");
	}

#define REGISTER_PACKET_TYPE_ENTRY(packetType, packetValue, packetSize) \
	packets[packetType].value = packetValue; \
	packets[packetType].size = packetSize; \
	strcpy(packets[packetType].string, #packetType);

	REGISTER_PACKET_TYPE_ENTRY(CB_LOGIN, 3, 66);
	REGISTER_PACKET_TYPE_ENTRY(CB_LOGIN_BY_PASSPORT, 4, 1052);
	REGISTER_PACKET_TYPE_ENTRY(CB_LOGOUT, 5, 10);
	REGISTER_PACKET_TYPE_ENTRY(CB_START_GAME, 10, 13);
	...
	REGISTER_PACKET_TYPE_ENTRY(CB_CHECK_CLIENT_INTEGRITY, 9, 74);
	REGISTER_PACKET_TYPE_ENTRY(CB_ECHO, 13, 30);
	REGISTER_PACKET_TYPE_ENTRY(CB_BARRACKNAME_CHANGE, 11, 74);
	REGISTER_PACKET_TYPE_ENTRY(CB_COMMANDER_MOVE, 12, 31);
	REGISTER_PACKET_TYPE_ENTRY(BC_LOGINOK, 14, 121);
	REGISTER_PACKET_TYPE_ENTRY(BC_LOGIN_PACKET_RECEIVED, 15, 6);
	REGISTER_PACKET_TYPE_ENTRY(BC_LOGOUTOK, 16, 6);
	REGISTER_PACKET_TYPE_ENTRY(BC_START_GAMEOK, 20, 33);
	REGISTER_PACKET_TYPE_ENTRY(BC_SINGLE_INFO, 21, 317);
	REGISTER_PACKET_TYPE_ENTRY(BC_COMMANDER_LIST, 17, 0);
	REGISTER_PACKET_TYPE_ENTRY(BC_COMMANDER_CREATE, 18, 326);
	REGISTER_PACKET_TYPE_ENTRY(BC_COMMANDER_DESTROY, 19, 7);
	REGISTER_PACKET_TYPE_ENTRY(BC_MESSAGE, 22, 0);
	REGISTER_PACKET_TYPE_ENTRY(BC_ECHO, 23, 26);
	...
	REGISTER_PACKET_TYPE_ENTRY(BC_MYPAGE_MAP, 24, 0);
	REGISTER_PACKET_TYPE_ENTRY(BC_BARRACKNAME_CHANGE, 25, 75);
	REGISTER_PACKET_TYPE_ENTRY(CB_VISIT, 75, 74);
	REGISTER_PACKET_TYPE_ENTRY(CB_BUY_THEMA, 76, 22);
	...
	REGISTER_PACKET_TYPE_ENTRY(CS_ADD_RELATION_SCORE, 2930, 88);
	REGISTER_PACKET_TYPE_ENTRY(CS_GET_LIKE_COUNT, 2931, 16);
	REGISTER_PACKET_TYPE_ENTRY(CS_LIKE_IT, 2927, 80);
	REGISTER_PACKET_TYPE_ENTRY(CS_UNLIKE_IT, 2928, 16);
	REGISTER_PACKET_TYPE_ENTRY(CS_LIKE_IT_CONFIRM, 2929, 16);
	REGISTER_PACKET_TYPE_ENTRY(CS_REQ_RELATED_PC_SESSION, 2919, 16);
	REGISTER_PACKET_TYPE_ENTRY(CS_REDIS_SKILLPOINT, 2920, 22);
	REGISTER_PACKET_TYPE_ENTRY(CS_PARTY_CLIENT_INFO_SEND, 2921, 0);
	REGISTER_PACKET_TYPE_ENTRY(CS_NORMAL_GAME_START, 2922, 6);
	REGISTER_PACKET_TYPE_ENTRY(CS_PVP_COMMAND, 2923, 18);
	REGISTER_PACKET_TYPE_ENTRY(CS_REQUEST_PVP_RANKING, 2924, 83);
	REGISTER_PACKET_TYPE_ENTRY(CS_INVITE_PARTY_PVP, 2925, 10);
	REGISTER_PACKET_TYPE_ENTRY(CS_ACCEPT_PARTY_PVP, 2926, 19);
	...
	REGISTER_PACKET_TYPE_ENTRY(CZ_SKILL_GROUND, 3094, 61);
	...
	REGISTER_PACKET_TYPE_ENTRY(ZC_ENTER_PC, 3006, 408);
	REGISTER_PACKET_TYPE_ENTRY(ZC_ENTER_MONSTER, 3007, 0);
	REGISTER_PACKET_TYPE_ENTRY(ZC_ENTER_DUMMYPC, 3008, 300);
	REGISTER_PACKET_TYPE_ENTRY(ZC_UPDATED_DUMMYPC, 3009, 258);
	...
	REGISTER_PACKET_TYPE_ENTRY(ZC_UPDATED_PCAPPEARANCE, 3027, 258);
	...
	REGISTER_PACKET_TYPE_ENTRY(ZC_SKILL_READY, 3035, 50);
	...
	REGISTER_PACKET_TYPE_ENTRY(CZ_REQ_NORMAL_TX, 3215, 45);
	...
	REGISTER_PACKET_TYPE_ENTRY(CZ_FOOD_TABLE_TITLE, 3247, 79);
	...
	REGISTER_PACKET_TYPE_ENTRY(CZ_SORT_INV, 3300, 12);
	...
	REGISTER_PACKET_TYPE_ENTRY(ZC_RECOMMEND_PARTYMEMBER_INFO, 3500, 0);
	...
	REGISTER_PACKET_TYPE_ENTRY(CZ_INV_ITEM_LOCK, 3465, 19);
	...
	REGISTER_PACKET_TYPE_ENTRY(ZC_NEAR_PARTY_LIST, 3475, 0);
	REGISTER_PACKET_TYPE_ENTRY(ZC_RECOMMEND_PARTY_INFO, 3476, 0);
	REGISTER_PACKET_TYPE_ENTRY(CZ_REQUEST_SOME_PARTY, 3477, 90);
	REGISTER_PACKET_TYPE_ENTRY(CZ_REFRESH_MEMBERRECOMMEND_LIST, 3478, 10);
	REGISTER_PACKET_TYPE_ENTRY(ZC_TO_SOMEWHERE_CLIENT, 3479, 0);
	REGISTER_PACKET_TYPE_ENTRY(CZ_REVEAL_NPC_STATE, 3480, 14);
	REGISTER_PACKET_TYPE_ENTRY(CZ_CHANGE_CHANNEL, 3481, 12);
	REGISTER_PACKET_TYPE_ENTRY(CZ_REQ_CHANNEL_TRAFFICS, 3482, 12);
	REGISTER_PACKET_TYPE_ENTRY(CZ_BUY_PROPERTYSHOP_ITEM, 3483, 0);
	REGISTER_PACKET_TYPE_ENTRY(CZ_SKILL_USE_HEIGHT, 3484, 14);
	REGISTER_PACKET_TYPE_ENTRY(CZ_ACCEPT_PARTY_QUEST, 3485, 20);
	REGISTER_PACKET_TYPE_ENTRY(CZ_ACCEPT_PARTY_EVENT, 3486, 20);
	REGISTER_PACKET_TYPE_ENTRY(CZ_DELETE_PARTY_EVENT, 3487, 20);
	REGISTER_PACKET_TYPE_ENTRY(CZ_PING, 3488, 10);
	REGISTER_PACKET_TYPE_ENTRY(ZC_PING, 3489, 10);
	REGISTER_PACKET_TYPE_ENTRY(ZC_XIGNCODE_BUFFER, 3490, 524);
	REGISTER_PACKET_TYPE_ENTRY(CZ_XIGNCODE_BUFFER, 3491, 524);
	REGISTER_PACKET_TYPE_ENTRY(CZ_SYSTEM_LOG_SAVE_TO_MONGODB, 3492, 280);
	REGISTER_PACKET_TYPE_ENTRY(CZ_CHANGE_TITLE, 3493, 74);
	REGISTER_PACKET_TYPE_ENTRY(CZ_PC_COMMENT_CHANGE, 3494, 0);
	REGISTER_PACKET_TYPE_ENTRY(CZ_AUTTOSELLER_BUYER_CLOSE, 3495, 18);
	REGISTER_PACKET_TYPE_ENTRY(CZ_REQ_ITEM_LIST, 3496, 11);
	REGISTER_PACKET_TYPE_ENTRY(CZ_HIT_MISSILE, 3497, 14);
	REGISTER_PACKET_TYPE_ENTRY(CZ_I_NEED_PARTY, 3498, 23);
	REGISTER_PACKET_TYPE_ENTRY(CZ_PARTY_JOIN_BY_LINK, 3499, 19);
	REGISTER_PACKET_TYPE_ENTRY(CZ_PVP_ZONE_CMD, 3501, 22);
	REGISTER_PACKET_TYPE_ENTRY(CZ_PVP_CHAT, 3502, 0);
	REGISTER_PACKET_TYPE_ENTRY(CZ_CARDBATTLE_CMD, 3503, 26);
	REGISTER_PACKET_TYPE_ENTRY(CZ_REQ_UPDATE_CONTENTS_SESSION, 3504, 10);
	REGISTER_PACKET_TYPE_ENTRY(CZ_REQ_FRIENDLY_FIGHT, 3505, 15);
	REGISTER_PACKET_TYPE_ENTRY(CZ_CART_POSITION, 3506, 26);
	REGISTER_PACKET_TYPE_ENTRY(CZ_REQ_RIDE_CART, 3507, 18);
	REGISTER_PACKET_TYPE_ENTRY(CZ_DUMMYPC_SKILL_POS, 3508, 26);
